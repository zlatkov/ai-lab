        ...
        <div className="mb-10">
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            {[
              ...
              { href: process.env.NEXT_PUBLIC_TYCOON_URL ?? 'https://tycoon.zlatkov.ai', name: 'ai-tycoon', desc: 'Build the AI industry — a city-builder tycoon game with an AI advisor' },
            ].map(p => (
              <a
                key={p.name}
                href={p.href}
